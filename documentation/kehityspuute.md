...
### Heroku
Tuotteiden listauksessa herokussa ei toiminut kategorian nimi, vaikka se onnistui saada näkyviin lokaalisti. Herokussa tuotteiden listauksessa näkyy kategorian kohdalla kategorian id. Lokaalisti näkyy kategorian nimi, mikä oli tavoitteena. Ongelma ilmeni vasta viimeisenä palautuspäivänä, enkä ehtinyt enää korjaamaan sitä oikein.
